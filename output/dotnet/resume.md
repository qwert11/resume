...
.NET / ASP.NET разработчик с опытом внутренних веб-систем, доступа и аутентификации, real-time уведомлений, интеграций, audit-сценариев, SQL и enterprise backend-разработки.
